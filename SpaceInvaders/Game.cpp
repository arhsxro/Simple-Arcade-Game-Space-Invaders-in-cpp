...
void Game::drawGameScreen() {
	...
	pr.texture = std::string(ASSET_PATH) + "protectors.png";
	if (level == 0) {
...
void Game::drawGameOverScreen() {
	...
	graphics::drawText(CANVAS_WIDTH / 2 - 240, CANVAS_HEIGHT / 2 + 150, 30, p, pr);

	std::string m = " PRESS <M> FOR MULTYPLAYER";
	graphics::drawText(CANVAS_WIDTH / 2 - 200, CANVAS_HEIGHT / 2 + 200, 30, m, pr);
